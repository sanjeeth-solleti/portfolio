...
const certifications = [
  {
    ...
    date: '2025',
    description: 'Demonstrated expertise in offensive security by mastering real-world ethical hacking, vulnerability exploitation, and advanced attack techniques.',
    icon: Award,
  ...
  },
  {
    ...
    authority: 'Coursera',
    date: '2025',
    description: 'Completed hands-on training in security operations, network security, risk management, and incident response using industry-standard tools.',
    icon: Award,
    iconColor: 'text-matrix-400',
    gradientFrom: 'from-matrix-500/20',
    gradientTo: 'to-matrix-600/20',
  ...
  },
  {
    ...
    authority: 'TryHackMe',
    date: '2025',
    description: 'Gained practical experience in SIEM monitoring, log analysis, alert triage, and basic incident handling in a simulated SOC environment.',
    icon: Award,
    iconColor: 'text-matrix-400',
    gradientFrom: 'from-matrix-500/20',
    gradientTo: 'to-matrix-600/20',
