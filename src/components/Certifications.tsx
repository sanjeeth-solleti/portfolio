                ...
                <div className="flex-1 text-center sm:text-left">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center sm:justify-start lg:justify-end text-matrix-400">
                        ...
                        <span className="font-semibold font-mono text-sm sm:text-base">Credential ID: ABC123</span>
                      </div>
                    </motion.div>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-gray-300 leading-relaxed mb-4 text-sm sm:text-base">
                      This certification validates knowledge and skills in cybersecurity fundamentals, 
                      including threat analysis, risk management, and security best practices. 
                      Demonstrates proficiency in industry-standard security tools and methodologies.
                    </p>
                  </motion.div>
